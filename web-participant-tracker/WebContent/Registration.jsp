...
<jsp:setProperty property="*" name="volunteer"/><input type="text" required name="name" value="<jsp:getProperty name="volunteer" property="name" />">   <%out.println(" Date:");%><input type="text" disabled="true" name="date" value="<%= new java.util.Date() %>" >   <%out.println(" </span></div>");
out.println("<div style=\"position:absolute;left:40.44px;top:197.66px\" class=\"cls_002\"><span class=\"cls_002\">Address:");%><input type="text" required name="address" value="<jsp:getProperty name="volunteer" property="address" />">   <%out.println(" </span></div>");
out.println("<div style=\"position:absolute;left:40.44px;top:220.10px\" class=\"cls_002\"><span class=\"cls_002\">E-mail:");%><input type="text" required name="email" value="<jsp:getProperty name="volunteer" property="email" />">   <%out.println(" </span></div>");
out.println("<div style=\"position:absolute;left:396.07px;top:220.10px\" class=\"cls_002\"><span class=\"cls_002\">Phone:");%><input type="text"  name="phonenum" value="<jsp:getProperty name="volunteer" property="phonenum" />">   <%out.println(" </span></div>");
...
out.println("<div style=\"position:absolute;left:42.96px;top:377.57px\" class=\"cls_002\"><span class=\"cls_002\">Name:");%><input type="text" required name="emergencycont" value="<jsp:getProperty name="volunteer" property="emergencycont" />">   <%out.println("  Relationship to Participant:");%><input type="text" required name="relationtype" value="<jsp:getProperty name="volunteer" property="relationtype" />">   <%out.println(" </span></div>");
out.println("<div style=\"position:absolute;left:40.44px;top:400.13px\" class=\"cls_002\"><span class=\"cls_002\">Phone Number:");%><input type="text" required name="relationph" value="<jsp:getProperty name="volunteer" property="relationph" />">   <%out.println(" </span></div>");
