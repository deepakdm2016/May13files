...
<jsp:setProperty property="*" name="volunteer"/><input type="text"  name="name" value="<jsp:getProperty name="volunteer" property="name" />">   <%out.println(" Date:");%><input type="text" disabled="true" name="date" value="<%= new java.util.Date() %>" >   <%out.println(" </span></div>");
out.println("<div style=\"position:absolute;left:40.44px;top:197.66px\" class=\"cls_002\"><span class=\"cls_002\">Address:");%><input type="text"  name="address" value="<jsp:getProperty name="volunteer" property="address" />">   <%out.println(" </span></div>");
out.println("<div style=\"position:absolute;left:40.44px;top:220.10px\" class=\"cls_002\"><span class=\"cls_002\">E-mail:");%><input type="text"  name="email" value="<jsp:getProperty name="volunteer" property="email" />">   <%out.println(" </span></div>");
out.println("<div style=\"position:absolute;left:396.07px;top:220.10px\" class=\"cls_002\"><span class=\"cls_002\">Phone:");%><input type="text" required name="phonenum" value="<jsp:getProperty name="volunteer" property="phonenum" />">   <%out.println(" </span></div>");
out.println("<div style=\"position:absolute;left:250.07px;top:197.66px\" class=\"cls_002\"><span class=\"cls_002\">Volunteering Options:");%><select name="volunteer_option">     <option value="Turban Tying">Turban Tying</option>     <option value="Line Management">Line Management</option>     <option value="IT help">IT help</option>     <option value="Turban Table">Turban Table</option>     <option value="Volunteer check in table">Volunteer check in table</option>     <option value="Interaction team in Langar">Interaction team in Langar</option>     <option value="Others">Others</option>     </select>  <%out.println(" </span></div>");
...
out.println("<div style=\"position:absolute;left:40.44px;top:287.69px\" class=\"cls_002\"><span class=\"cls_002\">Parent or Legal Guardian Name :");%><input type="text" name="guardianname" value="<jsp:getProperty name="volunteer" property="guardianname" />">   <%out.println(" </span></div>");
out.println("<div style=\"position:absolute;left:40.44px;top:310.13px\" class=\"cls_002\"><span class=\"cls_002\">Parent or Legal Guardian E-mail:");%><input type="text" name="guardianemail" value="<jsp:getProperty name="volunteer" property="guardianemail" />">   <%out.println(" </span></div>");
out.println("<div style=\"position:absolute;left:40.44px;top:332.69px\" class=\"cls_002\"><span class=\"cls_002\">Parent or Legal Guardian Phone :");%><input type="text" name="guardianphone" value="<jsp:getProperty name="volunteer" property="guardianphone" />">   <%out.println(" </span></div>");
...
out.println("<div style=\"position:absolute;left:42.96px;top:377.57px\" class=\"cls_002\"><span class=\"cls_002\">Name:");%><input type="text"  name="emergencycont" value="<jsp:getProperty name="volunteer" property="emergencycont" />">   <%out.println("  Relationship to Participant:");%><input type="text"  name="relationtype" value="<jsp:getProperty name="volunteer" property="relationtype" />">   <%out.println(" </span></div>");
out.println("<div style=\"position:absolute;left:40.44px;top:400.13px\" class=\"cls_002\"><span class=\"cls_002\">Phone Number:");%><input type="text"  name="relationph" value="<jsp:getProperty name="volunteer" property="relationph" />">   <%out.println(" </span></div>");
...
out.println("<div style=\"position:absolute;left:40.44px;top:437.11px\" class=\"cls_002\"><span class=\"cls_002\">");%><input type="text" name="allergies" value="<jsp:getProperty name="volunteer" property="allergies" />">   <%out.println(" </span></div>");
...
out.println("<div style=\"position:absolute;left:72.02px;top:664.06px\" class=\"cls_002\"><span class=\"cls_002\">willingly and voluntarily.");%><input type="Submit" value="I Agree" class="save"  onSubmit="return validateForm(this);" /></form> class="save"><a href="StudentControllerServlet">Back to List</a>
